...
#======================================================================================================
  ...
  pref <- h2o.performance(model = rf, newdata = OnedrugTestH2o)
  as.data.frame(h2o.confusionMatrix(pref))
  str(c(h2o.auc(pref),h2o.mse(pref),h2o.giniCoef(pref),h2o.confusionMatrix(pref)))
  h2o.gainsLift(rf,OnedrugTestH2o)
