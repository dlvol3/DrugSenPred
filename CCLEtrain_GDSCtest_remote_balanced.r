...
cat(capture.output(print(numberofavalibleDrugsCelllineList),
                   file = paste0(getwd(),"/output_balanced/numberofavalibleDrugsCelllineList.txt")))
...
for (i in 1:length(levels(as.factor(IC50CCLE$drug)))){
  ...
  pdf(paste0(getwd(),"/output_balanced/",drugg,"_CCLE.pdf"))  # The pdf receiving the output
  ...
  write.table(ub,file = paste0(getwd(),"/output_balanced/CCLEGDSC_unbalanced",drugg,".txt"),
  ...
  #======================================================================================================
  # Result of the model/prediction/output_balanced the result datatable/draw the ROC and PRC 
  #======================================================================================================
  ...
  cat(capture.output(print(summary(rf)),
                     file = paste0(getwd(),"/output_balanced/summaryrfCCLE_",drugg,".txt")))   ### print summary into a txt
  ...
  write.table(re,file = paste0(getwd(),"/output_balanced/PredictionCCLEtoGDSC_",drugg,".txt"),sep = '\t', col.names = TRUE,row.names = FALSE)
  ...
  write.table(decoP,file = paste0(getwd(),"/output_balanced/dicisionPATH",drugg,".txt"),sep = '\t', col.names = TRUE,row.names = FALSE)
